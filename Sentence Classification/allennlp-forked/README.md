Allennlp repository forked and modified in order for it to support addition of CoVe and other embeddings, in addition to the regular support for GloVe embeddings. 
